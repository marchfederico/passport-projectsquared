var express = require('express')
  ...
  , util = require('util')
  , ProjectSquaredStrategy = require('passport-projectsquared').Strategy;

var PROJECTSQUARED_CLIENT_ID = "--insert-id-here--"
var PROJECTSQUARED_CLIENT_SECRET = "--insert-secret-here--";
...
passport.use(new ProjectSquaredStrategy({
    clientID: PROJECTSQUARED_CLIENT_ID,
  ...
  function(accessToken, refreshToken, profile, done) {
    ...
    process.nextTick(function () {
      ...
      // To keep the example simple, the user's ProjectSquared profile is returned to
...
// GET /auth/projectsquared
//   Use passport.authenticate() as route middleware to authenticate the
//   request.  The first step in ProjectSquared authentication will involve
//   redirecting the user to projectsquared.com.  After authorization, ProjectSquared
//   will redirect the user back to this application at /auth/projectsquared/callback
